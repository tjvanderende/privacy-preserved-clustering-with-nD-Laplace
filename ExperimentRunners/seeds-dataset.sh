...
python main.py run-utility-experiments ../data/$2/$3.csv $1-laplace-optimal-truncated $2
...
python main.py run-privacy-experiments ../data/$2/$3.csv $1-laplace-optimal-truncated $2
python main.py run-privacy-experiments ../data/$2/$3.csv $1-laplace $2

python main.py run-comparison-experiment $4 $2
